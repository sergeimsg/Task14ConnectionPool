...
public class ConnectionPool {
    ...
    public void initPoolData() throws ConnectionPollException {
       // Locale.setDefault(Locale.ENGLISH);   - рудимент, ранее нужен был для Oracle, сейчас нет
        ...
        try {
            ...
            throw new ConnectionPollException( "SQL exception in Connection pool", e);
        }
    ...
    public Connection takeConnection() throws ConnectionPollException {
        ...
        try {
            ...
            throw new ConnectionPollException(
